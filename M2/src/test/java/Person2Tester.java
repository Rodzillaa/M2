...
public class Person2Tester {
  ...
  public void accountForAllLetters() {
    ...
    String persontest1randomized =
        persontest1string.substring(test1.length(), persontest1string.length());
    ...
    String persontest2randomized =
        persontest2string.substring(test2.length(), persontest2string.length());
    ...
    String persontest3randomized =
        persontest3string.substring(test3.length(), persontest3string.length());
    ...
    String persontest4randomized =
        persontest4string.substring(test4.length(), persontest4string.length());
    ...
    assertEquals(
        persontest5string.substring(0, test5.length()), "abcdefghijklmnopqrstuvwxyz0123456789");
    String persontest5randomized =
        persontest5string.substring(test5.length(), persontest5string.length());
    ...
    assertEquals(
        persontest6string.substring(0, test6.length()), "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
    String persontest6randomized =
        persontest6string.substring(test6.length(), persontest6string.length());
